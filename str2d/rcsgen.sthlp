...
{p2colset 5 21 23 2}{...}
{p2col :{hi: rcsgen} {hline 2}}Generate restriced cubic splines and derivatives{p_end}
{p2colreset}{...}
...
if2 and fw options. He also wrote the mata code for the Gram-Schmidt orthogonalization (as opposed to using the {help orthog} command).
